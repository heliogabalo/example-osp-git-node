...
db = "provaiders_db" # This is the name of the database we will create in the next step - call it whatever you like.
...
create_database_query = "CREATE DATABASE provaiders_db"
...
def create_provaiders_table = """
    CREATE TABLE provaiders(
      provaider_id INT PRIMARY KEY,
...
execute_query(connection, create_provaiders_table)
...
alter_offer = """
  ALTER TABLE offers
  ADD FOREIGN KEY(provaiders)
  REFERENCES clients(provaider_id)
  ON DELETE SET NULL;
"""
...
connection = create_db_connection("localhost", "root", pw, db)
execute_query(connection, alter_provaiders_table)
